...
#define MyAppName "BTCc Core"
#define MyAppPublisher "2022 Bitcoin Сharity Core Developers"
#define MyAppURL "https://btccdd.io"
#define MyAppExeName "btcc-qt.exe"
#define MyAppExtraData "https://explorer.forking-altcoins.net/bootstraps/BTCC/bootstrap.zip"
...
AppId={{5B0BF7CB-92F4-470D-A38F-D0434B3E3900}
AppName={#MyAppName}
...
[Files]
Source: ".\package\btcc-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\BTCc\BTCc-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\BTCc\BTCc-Qt,strDataDir|{userappdata}\BTCc\}');
  Result := True;
end;
