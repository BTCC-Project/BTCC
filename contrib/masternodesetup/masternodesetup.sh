...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='btcc.conf'
CONFIGFOLDER='/root/.btcc'
COIN_DAEMON='btccd'
COIN_CLI='btcc-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ=`curl -s https://api.github.com/repos/forking-altcoins/BTCC/releases/latest | grep "browser_download_url.*Linux\\.zip" | cut -d : -f 2,3 | tr -d \" | xargs`
