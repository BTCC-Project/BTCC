...
"""Verify that starting btcc with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start btcc with -? for help text")
        ...
        self.log.info("Start btcc with -version for version information")
