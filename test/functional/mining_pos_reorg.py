...
class ReorgStakeTest(PivxTestFramework):
    ...
    def check_money_supply(self, expected_piv):
        ...
        # verify that nodes have the expected BTCC supply
        for node in g_info:
    ...
    def run_test(self):
        ...
        # Check BTCC supply at the beginning
        # ------------------------------------------
        # BTCC supply: block rewards minus burned fees for minting
        ...
        # Verify that BTCC supplies were properly updated after the spends and reorgs
        self.log.info("Check BTCC supply...")
