...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("BTCc btcc-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  btcc-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded btcc transaction") + "\n" +
                               "  btcc-tx [options] -create [commands]   " + _("Create hex-encoded btcc transaction") + "\n" +
                               "\n";
...
static CAmount AmountFromValue(const UniValue& value)
{
    ...
    if (dAmount <= 0.0 || dAmount > 210000.0)
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded btcc transaction
