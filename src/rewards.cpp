...
// Copyright (c) 2021-2024 The Bitcoin Сharity Core Developers
...
CAmount CRewards::GetBlockValue(int nHeight)
{
    ...
    // ---- Static reward table ----
    if (nHeight > 500) nSubsidy = 0.001 * COIN;
    else if (nHeight > 1) nSubsidy = 0.1 * COIN;
    else if (nHeight > 0) nSubsidy = 2200 * COIN;
    else nSubsidy = 0;
    // ---- Static reward table ----
