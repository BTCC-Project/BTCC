...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* BTCC features */
        {"btcc", "listmasternodes", &listmasternodes, true },
        {"btcc", "getmasternodecount", &getmasternodecount, true },
        {"btcc", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"btcc", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"btcc", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"btcc", "masternodecurrent", &masternodecurrent, true },
        {"btcc", "startmasternode", &startmasternode, true },
        {"btcc", "reloadmasternodeconfig", &reloadmasternodeconfig, true },
        {"btcc", "createmasternodekey", &createmasternodekey, true },
        {"btcc", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"btcc", "listmasternodeconf", &listmasternodeconf, true },
        {"btcc", "getactivemasternodecount", &getactivemasternodecount, true },
        {"btcc", "getmasternodestatus", &getmasternodestatus, true },
        {"btcc", "getmasternodewinners", &getmasternodewinners, true },
        {"btcc", "getmasternodescores", &getmasternodescores, true },
        {"btcc", "mnsync", &mnsync, true },
        {"btcc", "spork", &spork, true },
        {"btcc", "mnping", &mnping, true },
...
{
    return "> btcc-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:22024/\n";
}
