...
/* BTCc GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "BTCc"
#define QAPP_ORG_DOMAIN "btcc.org"
#define QAPP_APP_NAME_DEFAULT "BTCc-Qt"
#define QAPP_APP_NAME_TESTNET "BTCc-Qt-testnet"
