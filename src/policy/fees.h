 ...
 * at the bucket with with the highest feerate transactions and verifying that a
...
/**
 *  We want to be able to estimate feerates or priorities that are needed on tx's to be included in
