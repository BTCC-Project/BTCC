Contributing to BTCc Core
============================

The BTCc Core project operates an open contributor model where anyone is
...
The following applies to code changes to the BTCc Core project, and is not to be
confused with overall BTCc Network Protocol consensus changes.

Whether a pull request is merged into BTCc Core rests with the project merge
...
Patches that change BTCc consensus rules are considerably more involved than
...
Where a patchset proposes to change the BTCc consensus, it must have been
...
The project leader is the release manager for each BTCc Core release.
